        ...
        if food_order == 'pizza':
            ...
            def choosing_pizza_number():
                ...
                if is_integer(pizza_number):
                    ...
                    return choosing_pizza_number() # in the end, the outermost function will be the final return( so, any case need to return something)
